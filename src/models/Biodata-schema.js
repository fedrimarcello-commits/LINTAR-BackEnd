module.exports = (db) =>
  db.model(
    ...
    new db.Schema({
      ...
      noIjazah: { type: String, required: true },
      tglIjazah: { type: String, required: true },
      namaOrangTuaWali: { type: String, required: true },
      alamatOrangTua: { type: String, required: true },
      teleponOrangTua: { type: String, default: '-' },
    })
  );
